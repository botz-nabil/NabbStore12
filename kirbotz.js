...
var button = [
{"urlButton": {"displayText": "MyOwner🔥","url": `https://wa.me/6288991078377`}},
...
hydratedFooterText: 'Created By Nabb Botz',
hydratedButtons: [{
urlButton: {
...
kirbotz.send5Loc(m.chat, `On Kak Silahkan Pencet Button Di Bawah\nJika Button Tidak Kelihatan Ketik ${prefix}menu`, `Created By Nabb Botz`, global.thumb, btn)
}
break
...
kirbotz.send5ButImg(i, junn, `Created By Nabb Botz`, buffer, butoon)
} else if (/video/.test(mime)) {
let junn = `*_BROADCAST VIDIO_*${text ? '\n\n' + text : ''}`
kirbotz.send5Vid(i, junn, `Created By Nabb Botz`, buffer, butoon)
